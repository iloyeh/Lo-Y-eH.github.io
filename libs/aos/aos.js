// 控制台警告： DOMNodeRemoved 事件的监听器已被废弃，并建议使用 MutationObserver 替代。DOMNodeRemoved 事件是用于监听 DOM 节点被移除的事件，但由于性能问题和兼容性考虑，现已弃用

// 2024/4/28 同步修改matery.js，因为牵涉文件太多，暂未修改
// 2024/5/21、2024/5/22 改了半天没成功，不如直接使用大佬夜法之书的代码
